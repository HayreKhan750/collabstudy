      ...
      <div className="flex flex-col items-center gap-1.5 py-3 border-b border-white/10">
            ...
            <button
              ...
              className={`w-9 h-9 rounded-xl flex items-center justify-center text-sm font-bold transition-all duration-150 mx-auto
                ${selectedWorkspace?.id === ws.id
                  ...
                  : 'bg-white/10 text-gray-300 hover:bg-indigo-500/80 hover:text-white hover:rounded-2xl'
                }`}
            >
        ...
        <SidebarTooltip label="Create workspace">
          <button
            ...
            className="w-9 h-9 rounded-xl bg-white/10 hover:bg-green-500 text-gray-400 hover:text-white flex items-center justify-center transition-all duration-150 hover:rounded-2xl mx-auto"
          >
            <PlusIcon size={4} />
          </button>
        </SidebarTooltip>
        <SidebarTooltip label="Discover workspaces">
          <button
            ...
            className="w-9 h-9 rounded-xl bg-white/10 hover:bg-blue-500/80 text-gray-400 hover:text-white flex items-center justify-center transition-all duration-150 hover:rounded-2xl mx-auto"
          >
            <CompassIcon />
          </button>
        </SidebarTooltip>
      ...
      {isOwner && selectedWorkspace && (
        <div className="flex items-center gap-1 mt-2">
          <button
            ...
            className="flex items-center gap-1 text-xs text-gray-400 hover:text-white px-2 py-1 rounded-md hover:bg-white/10 transition-colors"
          >
            <PencilIcon /> Rename
          </button>
          <button
            onClick={onDeleteWorkspace}
            className="flex items-center gap-1 text-xs text-gray-400 hover:text-red-400 px-2 py-1 rounded-md hover:bg-red-500/10 transition-colors"
          >
            <TrashIcon /> Delete
          </button>
        </div>
