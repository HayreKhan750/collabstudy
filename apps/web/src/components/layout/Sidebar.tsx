...
export default function Sidebar({
  ...
  return (
    <>
      {/* ── Desktop sidebar ─────────────────────────────────────────────────── */}
      <motion.aside
        className="hidden md:flex flex-col h-full bg-white/60 dark:bg-[#1a1744]/30 backdrop-blur-3xl border-r border-gray-200 dark:border-white/[0.08] shadow-[4px_0_24px_-10px_rgba(0,0,0,0.4)] flex-shrink-0 z-20"
        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed inset-y-0 left-0 w-72 bg-white/60 dark:bg-[#1a1744]/30 backdrop-blur-3xl border-r border-gray-200 dark:border-white/[0.08] shadow-[4px_0_24px_-10px_rgba(0,0,0,0.4)] z-50 md:hidden flex flex-col"
            >
              {sidebarContent}
            </motion.aside>
          </>
