...
export default function Sidebar({
  ...
  return (
    <>
      {/* ── Desktop sidebar ─────────────────────────────────────────────────── */}
      <motion.aside
        className="hidden md:flex flex-col h-full bg-white/80 backdrop-blur-lg dark:bg-[#0B0D17] border-r border-slate-200/50 dark:border-white/[0.04] shadow-[1px_0_12px_-4px_rgba(0,0,0,0.08)] dark:shadow-[4px_0_24px_-10px_rgba(0,0,0,0.5)] flex-shrink-0 z-20"
        ...
        {mobileOpen && (
          <>
            ...
            <motion.aside
              ...
              className="fixed inset-y-0 left-0 w-72 bg-white/80 backdrop-blur-lg dark:bg-[#0B0D17] border-r border-slate-200/50 dark:border-white/[0.04] shadow-[1px_0_12px_-4px_rgba(0,0,0,0.08)] dark:shadow-[4px_0_24px_-10px_rgba(0,0,0,0.5)] z-50 md:hidden flex flex-col"
            >
              {sidebarContent}
            </motion.aside>
          </>
