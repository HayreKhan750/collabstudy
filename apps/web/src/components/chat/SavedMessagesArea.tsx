...
export default function SavedMessagesArea({ onBack, socket }: SavedMessagesAreaProps) {
  ...
  return (
    <div
      className="aurora-canvas-dark flex flex-col flex-1 h-full w-full relative overflow-hidden"
    ...
    >
                    ...
                    {editingId === msg.id ? (
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex gap-2">
                          <button onClick={handleEditSave} className="px-3 py-1 text-xs bg-indigo-500 text-white hover:text-white rounded-lg hover:bg-indigo-600 transition-colors">Save</button>
      ...
      {/* ── Input area ─────────────────────────────────────────────────────── */}
      <div className="flex-shrink-0 border-t border-slate-200/60 dark:border-white/[0.06] bg-white/70 backdrop-blur-xl dark:bg-[#0F1220]/80 dark:backdrop-blur-2xl w-full flex justify-center pb-6 px-4 mt-auto pt-3 relative z-10">
