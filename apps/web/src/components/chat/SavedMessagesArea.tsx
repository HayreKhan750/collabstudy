...
export default function SavedMessagesArea({ onBack, socket }: SavedMessagesAreaProps) {
  ...
  return (
    <div
      className="flex flex-col flex-1 h-full w-full overflow-hidden bg-slate-50 dark:aurora-canvas"
    ...
    >
      ...
      {/* ── Input area ─────────────────────────────────────────────────────── */}
      <div className="flex-shrink-0 border-t border-black/5 dark:border-white/[0.06] bg-white/60 dark:bg-[#0b0f1e]/70 backdrop-blur-2xl w-full flex justify-center pb-6 px-4 mt-auto pt-3 relative z-10">
