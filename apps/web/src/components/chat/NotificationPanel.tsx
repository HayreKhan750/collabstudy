        ...
        {open && (
          <>
            ...
            <motion.div
              ...
              className="absolute left-0 top-full mt-2 w-96 max-w-[calc(100vw-2rem)] max-h-[80vh] flex flex-col z-50
            ...
            >
                        ...
                        <div className="space-y-1">
                          {digest.unreadChannels.map((ch) => (
                            <button
                              ...
                              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-slate-100 dark:hover:bg-white/5 transition-colors text-left group"
                            >
                              {/* Icon */}
              ...
              {/* Footer */}
              {digest && !loading && (
                <div className="px-4 py-3 border-t border-slate-100 dark:border-white/10 flex-shrink-0">
